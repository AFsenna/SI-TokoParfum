                        ...
                        <div class="card-body">
                            ...
                            <form action="index.php?page=Auth&aksi=authAdmin" method="POST">
                                <div class="form-group">
                                    <label for="usernameAD" class="sr-only">Username</label>
                                    <input type="username" name="usernameAD" id="usernameAD" class="form-control" placeholder="Username">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="passwordAD" class="sr-only">Password</label>
                                    <input type="password" name="passwordAD" id="passwordAD" class="form-control" placeholder="***********">
                                </div>
